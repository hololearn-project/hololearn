...
// Javascript for the chatbox that is used in the 3D environment.
// The chatbox can be used by all students and the teacher.
// They can see all messages from all rooms.
...
// When the user itself sends a message it will be added
// to the right side of the chat.
...
function openOrCloseChat() { // eslint-disable-line no-unused-vars
  ...
  if (chatbox.style.display == 'block') {
    ...
    // The little bubble that shows that there are new messages is reset
...
/**
 * Shows that the number of new messages on the chatbox icon.
 * This is reset when the chatbox is opened.
 */
