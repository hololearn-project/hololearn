...
# from data_streams.vstreamer import WebcamVideoTrack, FlagVideoStreamTrack
...
async def main(pc, mediatracks):
    ...
    Once offer is received, create an answer and
    communicate it back to offerer through socket.
    Once peer connection is established,
    start listening for media tracks / data channel.
    ...
    async def offer(data):
        ...
        # Create a new RTCSessionDescription using
        # the data that was sent through socket connection.
        # sdp: string containing a SDP message describing the
        # session type describes the current state of the
        # session description, in this case it's 'offer'.
        offer = RTCSessionDescription(sdp=data["sdp"], type=data["type"])
        print("trying to add nodejs sdp as our remote description")
        print(offer)
        # Set the peer connection's remote description to be
...
if __name__ == "__main__":
    ...
    # Keep the asyncio loop running until connection closed
    # or keyboard interrupt found.
