...
class Test_Camera_Functions(unittest.TestCase):
    ...
    def test_set_focal_window_valid(self):
        ...
        img_altered = cam.set_focal_window(image=img, range=1000)
    ...
    def test_find_min_max_non_zero_valid_zero(self):

        img = np.zeros((10, 10))

        x_0, x_n, y_0, y_n = cam.find_min_max_non_zero(image=img)

        self.assertEqual((x_0, x_n, y_0, y_n), (0, 0, 0, 0))
    ...
    def test_process_depth_valid(self):
        ...
        self.assertEqual(img_proc.shape, (img.shape[0], 400, 3))
